...
get_current_branch () {
    ...
    if [ ! -z "$branch_name" -a "$branch_name" != " " ]; then
        echo " - [$branch_name]"
    fi
}

if [ "$color_prompt" = yes ]; then
    PS1='\[\033[0;32m\]\[\033[0m\033[0;32m\]\u@\h\[\033[0;36m\] \w\[\033[0;32m\]$(get_current_branch)\[\033[0m\033[0;32m\] \$\[\033[0m\033[0;32m\]\[\033[0m\] '
